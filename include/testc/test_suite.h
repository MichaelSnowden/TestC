 ...
 * tests. A suite doesn't have to be a tree, but it usually is. You should use the macros below
 * to declare tests and suites because doing them by hand is really slow.
 */
